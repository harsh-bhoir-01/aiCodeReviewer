...
const prompt = ` Your are an expert frontend software engineer reviewing the code in an interview . You need to review and complete the tasks
...
10. There is no word limit to your feedback. You must either provide suggestion/feedback/improvements or state as small generic message regarding no need of 
...
if no changes are needed, clearly state. "No improvement are neccessary".`;
